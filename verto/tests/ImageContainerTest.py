...
class ImageContainerTest(ProcessorTest):
    ...
    # def test_caption_false_numbered_list(self):
        ...
        # # self.assertListEqual([False, False, False, False, True], [ImageContainerBlockProcessor(self.ext, self.md.parser).test(blocks, block) for block in blocks], msg='"{}"'.format(test_string))
    ...
    # def test_caption_true_not_provided_numbered_list(self): # throw error
        ...
        # # self.assertListEqual([False, True, False], [ImageContainerBlockProcessor(self.ext, self.md.parser).test(blocks, block) for block in blocks], msg='"{}"'.format(test_string))
    ...
    # def test_image_in_image_tag(self): # throw error
        ...
        # # self.assertListEqual([True, False, True, False, True, True], [ImageContainerBlockProcessor(self.ext, self.md.parser).test(blocks, block) for block in blocks], msg='"{}"'.format(test_string))
    ...
    # def test_external_image(self):
        ...
        # # self.assertListEqual([True, False], [ImageContainerBlockProcessor(self.ext, self.md.parser).test(blocks, block) for block in blocks], msg='"{}"'.format(test_string))
    ...
    # def test_contains_multiple_images(self):
        ...
        # # self.assertListEqual([False, True, False, True, False, True, False], [ImageContainerBlockProcessor(self.ext, self.md.parser).test(blocks, block) for block in blocks], msg='"{}"'.format(test_string))
    ...
    # def test_text_contains_the_word_image(self):
        ...
        # # self.assertListEqual([False], [ImageContainerBlockProcessor(self.ext, self.md.parser).test(blocks, block) for block in blocks], msg='"{}"'.format(test_string))
    ...
    # def test_contains_hover_text(self):
        ...
        # # self.assertListEqual([True], [ImageContainerBlockProcessor(self.ext, self.md.parser).test(blocks, block) for block in blocks], msg='"{}"'.format(test_string))
    ...
    # def test_image_in_numbered_list(self):
        ...
        # # self.assertListEqual([False, False, False, True, False], [ImageContainerBlockProcessor(self.ext, self.md.parser).test(blocks, block) for block in blocks], msg='"{}"'.format(test_string))
