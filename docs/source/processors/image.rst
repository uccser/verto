...
- ``file_path`` - The path to the image.
    ...
    - Each file_path provided is added to the ``images`` set in required files stored by Kordac. The set of filepaths can be accessed after conversion, see :ref:`accessing_kordac_data`.
